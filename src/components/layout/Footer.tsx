...
const Footer = () => {
  ...
  return (
    <footer className="bg-sammy-dark text-white pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <a href="#" className="h-10 w-10 rounded-full bg-sammy-pink/20 flex items-center justify-center hover:bg-sammy-pink/40 transition-colors">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-sammy-pink">Quick Links</h3>
            <ul className="space-y-2">
              <li><Link to="/" className="text-gray-300 hover:text-sammy-pink transition-colors">Home</Link></li>
              <li><Link to="/products" className="text-gray-300 hover:text-sammy-pink transition-colors">Products</Link></li>
              <li><Link to="/about" className="text-gray-300 hover:text-sammy-pink transition-colors">About Us</Link></li>
              <li><Link to="/contact" className="text-gray-300 hover:text-sammy-pink transition-colors">Contact Us</Link></li>
              <li><Link to="/account" className="text-gray-300 hover:text-sammy-pink transition-colors">My Account</Link></li>
              <li><Link to="/cart" className="text-gray-300 hover:text-sammy-pink transition-colors">Shopping Cart</Link></li>
            </ul>
          </div>
          ...
          {/* Contact Info */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-sammy-pink">Contact Us</h3>
            <ul className="space-y-4">
              <li className="flex items-start">
                <MapPin className="h-5 w-5 text-sammy-pink mr-3 mt-0.5" />
                <span className="text-gray-300">Mitumba Market, Gikomba, Nairobi, Kenya</span>
              </li>
              <li className="flex items-center">
                <Phone className="h-5 w-5 text-sammy-pink mr-3" />
                <span className="text-gray-300">+254 790 881 268</span>
              </li>
              <li className="flex items-center">
                <Mail className="h-5 w-5 text-sammy-pink mr-3" />
                <span className="text-gray-300">info@sammymitumba.co.ke</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 border-t border-gray-700 pt-8">
          <p className="text-center text-gray-400 text-sm">
            &copy; {currentYear} Sammy Mitumba Stores. All rights reserved. | 
            <Link to="/privacy-policy" className="text-gray-300 hover:text-sammy-pink ml-1">
              Privacy Policy
            </Link> | 
            <Link to="/terms" className="text-gray-300 hover:text-sammy-pink ml-1">
              Terms of Service
            </Link>
          </p>
        </div>
